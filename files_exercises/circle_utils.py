...
For example, if your module contains a function called area(radius), 
you can call area(5) directly after importing it.

2. File Handling:
File handling allows you to read from and write to files on your computer. 
This is useful for saving results or 
loading data for your programs. Python provides built-in functions for this:
...
Instructions:
Create a Python module (circle_utils.py) with a function that calculates the area of a circle. 
